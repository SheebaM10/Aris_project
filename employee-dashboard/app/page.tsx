...
export default function EmployeeDashboard() {
  ...
  const renderContent = () => {
    ...
    switch (activeSection) {
      ...
      case "insights":
        return <TrendsInsights employee={employee} />
      case "admin":
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <CardContent>
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>
                        {Math.round(
                          employee.skills.reduce((acc, skill) => acc + skill.current_level, 0) / employee.skills.length,
                        )}
                        %
                      </span>
                    </div>
              ...
              >
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-secondary transition-colors">
                    Certifications, Experience Level
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-3">
              ...
              >
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-chart-1 transition-colors">
                    AI-calculated Competency Score
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-3">
              ...
              >
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-chart-2 transition-colors">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Button
                    variant="outline"
                    className="h-auto p-4 flex flex-col items-center gap-2 bg-transparent hover:bg-primary/5 hover:border-primary/50 transition-all group"
